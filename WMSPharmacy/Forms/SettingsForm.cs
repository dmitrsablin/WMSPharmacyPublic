...
namespace WMSPharmacy.Forms
{
    public partial class SettingsForm : Form
    {
        ...
        private void CreateDbButtonClick(object sender, EventArgs e)
        {
            ...
            //Все для упрощения установки и ознокомления

            //Разбиваем на несколько контекстов,
            //Что бы не держать в памяти все объекты сразу
            //Т.к. сборка мусора может начаться раньше записи в бд 

            //Типы товаров и производители
            using (var context = new WmsPharmacyContext())
            {
                ...
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Smart H-Mobile Co." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Federal Space Research Groups" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "3WorldWide Partners Corporation" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Special Engineering Group" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "General B-Mobile Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Professional Wind Energy Inc." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Home Protection Corporation" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Home High-Technologies Group" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Pacific O-Mobile Group" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "North Space Research Inc." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Union High-Technologies Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Union Trust Inc." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Professional Business Co." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "East Space Explore Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "First High-Technologies Inc." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "North Telecom Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "South Travel Inc." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Pacific High-Technologies Group" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Canadian High-Technologies Inc." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "WorldWide M-Mobile Co." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Special High Corporation" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "First Systems Corporation" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "International High Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Creative Explore Corporation" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "City G Wireless Co." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Creative Research Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Canadian Space Explore Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Future High-Technologies Co." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "International Industry Inc." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "West Coast I-Mobile Group" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Western Data Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "American Travel Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "National Data Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "American Explore Co." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "National High Corporation" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Domestic Space Research Inc." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Smart Services Group" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Future S-Mobile Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Special Space Explore Corp." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Future High Corporation" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Global Devices Corporation" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Western Petroleum Co." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "National Mobile Inc." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "Advanced E-Mobile Inc." });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "East Green Resources Group" });
                context.Manufacturers.Add(new Manufacturers { ManufacturerName = "North Nuclear Resources Inc." });

                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Patio" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Outdoors" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Pharmacy" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Electronics" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Pharmacy" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Garden" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Books" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Clothing" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Sports" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Jewelry" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Electronics" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Music" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Baby" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Movies" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Garden" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Books" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Health" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Outdoors" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Audible" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Clothing" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Shoes" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Sports" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Gifts" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Audible" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Office" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Computers" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Clothing" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Crafts" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Shoes" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Shoes" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Health" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Crafts" });
                ...
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Outdoors" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Health" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Beauty" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Accessories" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Baby" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Games" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Gifts" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Baby" });
                context.MedicinesTypes.Add(new MedicinesTypes { MedicinesTypeName = "Pharmacy" });
            ...
            using (var context = new WmsPharmacyContext())
            {
                ...
                context.UserRoles.Add(new UserRoles { NameRole = "Администратор" });
                context.UserRoles.Add(new UserRoles { NameRole = "Computer Operator" });
                context.UserRoles.Add(new UserRoles { NameRole = "Travel Agent" });
                context.UserRoles.Add(new UserRoles { NameRole = "Application Development Supervisor" });
                context.UserRoles.Add(new UserRoles { NameRole = "Marketing Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "Application Engineer" });
                context.UserRoles.Add(new UserRoles { NameRole = "Technical Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "Assistant Vice President" });
                context.UserRoles.Add(new UserRoles { NameRole = "Service Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "QA Engineer" });
                context.UserRoles.Add(new UserRoles { NameRole = "Communication Consultant" });
                context.UserRoles.Add(new UserRoles { NameRole = "Senior Specialist" });
                context.UserRoles.Add(new UserRoles { NameRole = "Secretary" });
                context.UserRoles.Add(new UserRoles { NameRole = "Contract Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "Chief Technology Officer" });
                context.UserRoles.Add(new UserRoles { NameRole = "Contract Advisor" });
                context.UserRoles.Add(new UserRoles { NameRole = "Network Administrator" });
                context.UserRoles.Add(new UserRoles { NameRole = "Technical Specialist" });
                context.UserRoles.Add(new UserRoles { NameRole = "Area Administrator" });
                context.UserRoles.Add(new UserRoles { NameRole = "Finance Controller" });
                context.UserRoles.Add(new UserRoles { NameRole = "Senior Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "Secretary" });
                context.UserRoles.Add(new UserRoles { NameRole = "Senior Specialist" });
                context.UserRoles.Add(new UserRoles { NameRole = "Secretary" });
                context.UserRoles.Add(new UserRoles { NameRole = "Commercial Director" });
                context.UserRoles.Add(new UserRoles { NameRole = "Vice President" });
                context.UserRoles.Add(new UserRoles { NameRole = "Senior Advisor" });
                context.UserRoles.Add(new UserRoles { NameRole = "Channel Sales Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "Sales Coordinator" });
                context.UserRoles.Add(new UserRoles { NameRole = "Solution Architect" });
                context.UserRoles.Add(new UserRoles { NameRole = "Branch Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "President" });
                context.UserRoles.Add(new UserRoles { NameRole = "Chief Financial Officer" });
                context.UserRoles.Add(new UserRoles { NameRole = "Support Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "Advisor" });
                context.UserRoles.Add(new UserRoles { NameRole = "Director of Sales" });
                context.UserRoles.Add(new UserRoles { NameRole = "Business Analyst" });
                context.UserRoles.Add(new UserRoles { NameRole = "Business Consultant" });
                context.UserRoles.Add(new UserRoles { NameRole = "Billing Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "Customer Relations Supervisor" });
                context.UserRoles.Add(new UserRoles { NameRole = "Security Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "Vice President" });
                context.UserRoles.Add(new UserRoles { NameRole = "Assistant" });
                context.UserRoles.Add(new UserRoles { NameRole = "Director of Customer Support" });
                context.UserRoles.Add(new UserRoles { NameRole = "Secretary" });
                context.UserRoles.Add(new UserRoles { NameRole = "Project Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "Business Analyst" });
                context.UserRoles.Add(new UserRoles { NameRole = "Travel Agent" });
                context.UserRoles.Add(new UserRoles { NameRole = "Regional Manager" });
                context.UserRoles.Add(new UserRoles { NameRole = "Finance Manager" });
            ...
            using (var context = new WmsPharmacyContext())
            {
                ...
                context.Medicines.Add(new Medicines()
                {
                    ...
                    Structure = "Injury of unspecified nerve at lower leg level, unspecified leg, subsequent encounter",
                ...
                context.Medicines.Add(new Medicines()
                {
                    ...
                    Structure = "Poisoning by glucocorticoids and synthetic analogues, assault, subsequent encounter",
